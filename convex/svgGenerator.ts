...
export async function generateSocialBadge(
  ...
  <svg x="${iconX}" y="${iconY}" width="${iconSize}" height="${iconSize}" viewBox="0 0 20 20" fill="none">
    ${iconSvg}
  </svg>
...
export async function generateCloudButton(): Promise<string> {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="88" height="48" viewBox="0 0 88 48">
